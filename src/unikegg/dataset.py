...
def manifest(directory, kind, reviewed=None):
    ...
    temporary = None
    try:
        # Unlike NamedTemporaryFile (0600), exclusive open honors the normal
        # output umask. A non-root ETL container must be able to read a bundle
        # generated by a different host UID. Keep explicitly restricted modes.
